...
# naključna števila.
# 
#     v <- numeric(1000000)       #vektor z milijon ničlami
#     for(i in 1 : 1000000) {
#       v[i] <- runif(1)             #runif privzeto med 0 in 1, head(v)..samo začetek vrstice izpiše
#     }
# 
