...
# Vaš projekt 
#
# Zgornji postopek lahko ponovite na podatkih, ki ste jih uvozili v sklopu
# vašega projekta. Na spletnih straneh [GADM](http://gadm.org/) in
# [StatSilk](http://www.statsilk.com/maps/download-free-shapefile-maps)
# lahko najdete zemljevide za vsako državo in cel svet, pa še marsikaj
# drugega.
# 
# Navadno so države razdeljene na administrativne enote (npr. občine,
# province, zvezne države, ...). Če imate podatke npr. po mestih, boste
# potrebovali podatek, v kateri enoti se nahaja vaše mesto.
# ================================================================@003594=
# 1. podnaloga
# Veselo na delo!
# ========================================================================
